...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogin,
      @NonNull ImageView imageView, @NonNull EditText textEmailAddress,
      @NonNull EditText textPassword, @NonNull TextView textRegister, @NonNull TextView textView,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.textEmailAddress;
      EditText textEmailAddress = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, btnLogin, imageView,
          textEmailAddress, textPassword, textRegister, textView, textView2);
    }
